...
import com.example.lttbdd_t2_b2.ui.BooksScreen
import com.example.lttbdd_t2_b2.ui.BorrowScreen
import com.example.lttbdd_t2_b2.ui.UsersScreen
import com.example.lttbdd_t2_b2.ui.viewmodel.LibraryViewModel

sealed class Screen(val route: String, val icon: ImageVector, val title: String) {
    object Books : Screen("books", Icons.Filled.Book, "DsSách")
    object Users : Screen("users", Icons.Filled.Person, "Nhân viên")
